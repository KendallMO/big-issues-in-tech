...
//Extension: How can I write a loop so it prints only the information of scholars who are 15-years-old? 16-years


print(scholarNames[0])
//used indexes, try indexes for the code challenge!

print(scholarNames[0])
print(scholarAges[0])
print(scholarHobbies[0])
